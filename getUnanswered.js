...
const getUnanswered = async _ => {
  ...
  const userTimeline = await T.get('statuses/user_timeline', { screen_name: 'EvitoClick', count: 200 });
  ...
  const timeline = await T.get('statuses/mentions_timeline', { screen_name: 'EvitoClick', count: 200 });
